...
| TASK-008 | Require on-wire status and MQTT for release-refuse reasons; limit a checked bench row to that row; name finite burst/re-arm as the missing sequence behaviour | ✅ | 2026-09-23 |
...
- **TEST-004**: Capture-rate text names 20 kSPS at the 20 kHz default and 200 kSPS at the 200 kHz ceiling. The status/MQTT gate requires the reason on both wires; a target compile does not count.
