...
- **REQ-003**: Cross-link PRODUCT_READINESS capture/dither gaps and R-AFDD-R roadmap framing when present.
...
- **TEST-003**: Future (out of scope): host Unity `test_afdd_features` for band energy / kurtosis on synthetic vectors.
